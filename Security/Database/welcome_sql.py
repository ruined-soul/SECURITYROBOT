...
from Security.Handlers.msg_types import Types
from Security.Database import BASE, SESSION
from sqlalchemy import BigInteger, Boolean, Column, String, UnicodeText

DEFAULT_WELCOME = "DEAR {first}, HOW ARE YOU?"
DEFAULT_GOODBYE = "WHY ARE YOU LEAVE ME ALONE BUDDY!"
